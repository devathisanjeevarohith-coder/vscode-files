# Aggregation : A relationship where an object contains references to other 
#               INDEPENDENT oobjects "has-a" relationship

# Composition : The composed object directly owns its components, which cannot
#               exists independently "owns-a" relationship
...
class Car:
    def __init__(self, make, model, horse_power, wheel_size):
        ...
        # self.wheel = Wheel(wheel_size)  -->  for one wheel
